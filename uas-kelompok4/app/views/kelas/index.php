        ...
        <table class="mt-4 min-w-full overflow-hidden rounded-t-lg">
            <thead class="text-md bg-[#5570ed]">
                <tr>
                    ...
                    <th class="p-2.5 text-white">Jurusan</th>
            ...
            <tbody class="table-auto">
                ...
                foreach ($data['kelases'] as $kelas) {
                    ...
                    echo "<td class='p-3'>" . $kelas['id'] . "</td>";
                    echo "<td class='p-3'>" . $kelas['nama'] . "</td>";
                    echo "<td class='p-3'>" . $kelas['jurusan_nama'] . "</td>";
                    echo "<td class='h-full w-min'>" .
                        "<div class='flex gap-3'>" .
                        "<a href='" . BASEURL . "/kelas/detail/" . $kelas['id'] . "' class='text-white font-semibold px-4 py-1 bg-[#5570ed] hover:bg-[#3c51b1] duration-200 rounded-lg'>preview</a>" .
                        "<a href='" . BASEURL . "/kelas/delete/" . $kelas['id'] . "' class='text-white font-semibold px-4 py-1 bg-[#ED5555] hover:bg-[#9e3939] duration-200 rounded-lg'>delete</a>" .
                        "</div>" .
                        "</td>";
                    echo "</tr>";
                }
